...
const config = {
  ...
  organizationName: 'TReNDS', // Usually your GitHub org/user name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Discussions',
                href: 'https://github.com/trendscenter/coinstac/discussions',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} TReNDS Center`,
      },
      prism: {
