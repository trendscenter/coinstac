...
// @NOTE these tests are completely valid.  they really need to be restored pronto.
// https://github.com/electron/electron/issues/5851 prevents us from using real
// fs-db mechanisms, and hence, we had to resort to using node-localstorage+
// pouchdb-adapter-localstorage to get our code running. the caveat is that all dbs
// now live in the same dir, which is against expectation with other adapters.
