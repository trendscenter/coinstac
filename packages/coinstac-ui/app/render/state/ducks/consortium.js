...
export const fetchConsortium = applyAsyncLoading(function fetchConsortium(id) {
  return (dispatch) => {
 ...
 * @returns {undefined}
 */
export const saveConsortium = applyAsyncLoading(function saveConsortium(consortium) {
  return (dispatch) => {
