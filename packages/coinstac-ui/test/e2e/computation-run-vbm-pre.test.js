...
const COMPUTATION_TIMEOUT = 3200000;
...
const COMPUTATION_NAME = 'VBM Preprocessor';
...
describe('e2e run computation with 1 member', () => {
  ...
  it('creates a pipeline', async () => {
    ...
    await addCovariate('site', 'string', 3);
    ...
    await appWindow.click('#data-0-data-dropdown-menu li:has-text("NiFTI")', { timeout: EXIST_TIMEOUT });
