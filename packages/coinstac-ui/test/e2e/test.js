...
describe('Testing::e2e', () => {
  ...
  it('sets the created pipeline to the consortium', () => (
    app.client
      ...
      .waitForVisible(`div=${PIPELINE_COMPUTATION_STEP_NAME} Download Complete`, COMPUTATION_DOWNLOAD_TIMEOUT)
      .click('.notification .notification-dismiss')
      .waitForVisible(`div=${PIPELINE_COMPUTATION_STEP_NAME} Download Complete`, EXIST_TIMEOUT, true)
      .waitForVisible('.notification', COMPUTATION_DOWNLOAD_TIMEOUT)
      .click('.notification .notification-dismiss')
      .waitForVisible('.notification', EXIST_TIMEOUT, true)
  ));
